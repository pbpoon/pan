# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-04-05 15:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mark_d', models.DateField(verbose_name='抄表日期')),
                ('meter_num', models.DecimalField(decimal_places=2, default=0, max_digits=9, verbose_name='水表度数')),
                ...
                ('is_post', models.BooleanField(default=False, verbose_name='发布')),
            ],
            options={
                'verbose_name': '总表信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meter_num', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='水表度数')),
                ('ps', models.CharField(blank=True, max_length=200, null=True, verbose_name='备注信息')),
                ('is_pay', models.BooleanField(default=False, verbose_name='已缴费')),
                ('create_d', models.DateTimeField(auto_now_add=True, verbose_name='录入日期')),
                ('update_d', models.DateTimeField(auto_now=True, verbose_name='修改日期')),
